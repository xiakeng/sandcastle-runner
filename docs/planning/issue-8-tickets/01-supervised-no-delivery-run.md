...
- [ ] External reads use at most five total calls, five-second gaps, and a 60-second invocation timeout. Exhaustion pauses. Safe set-like writes may retry four times with 10, 20, 40, and 80 second gaps; state-confirmed writes reconcile before the first attempt and after failures; resource-creating writes pause without automatic replay. Local reads do not inherit remote-read retries.
